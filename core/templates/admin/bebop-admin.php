...
<div id='bebop_admin_container'>
	...
	<div class='postbox-container'>
		<div id="normal-sortables" class="meta-box-sortables ui-sortable"><div class='postbox'>
			...
			<div class='inside'>
				<p><?php _e( 'Version 1.2.3 is a minor release which fixes a few compatability issued with WP 3.5.1 and BP 1.6.4. It also adds more information on chearing any required apps, API keys, and API secrets.', 'bebop' ); ?></p>
