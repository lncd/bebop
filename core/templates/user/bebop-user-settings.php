			...
			if ( ! empty( $query_string ) ) {
				...
				if ( count( $active_extensions ) == 0 ) {
					...
					foreach ( $active_extensions as $extension ) {
						...
						echo '<div class="button_container"><a class="button-secondary min_width_100" href="' . $bp->loggedin_user->domain . bp_current_component() . '/' . bp_current_action() . '/' . $extension['name'] .'">' . $extension['display_name'] . '</a></div>';
					}
				}
			}
		}
