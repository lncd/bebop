...
<div id='bebop_admin_container'>
	<div class="postbox center_margin margin-bottom_22px bebop_provider_helper hidden">
		...
		<div class="inside">
			...
			<ol>
				<li>Go to the <a target="_blank" href="http://www.slideshare.net/developers">SlideShare developers page</a>. Click <b>apply</b>.</li>
				<li>Complete and submit the form as instructed. SlideShare will them email you your details.</li>
				<li>Copy the <b>App Key</b> into the <b>SlideShare API Token</b> field and <b>Shared Secret</b> into the <b>SlideShare API Secret</b> field on this page.</li>
